...
class Contact(models.Model):
    store = models.ForeignKey(Store, on_delete=models.CASCADE, related_name='contact_stores')
...
class Address(models.Model):
    store = models.ForeignKey(Store, on_delete=models.CASCADE, related_name='address_stores')
...
class StoreMenu(models.Model):
    store = models.ForeignKey(Store, on_delete=models.CASCADE, related_name='menu_stores')
...
class Product(models.Model):
    store = models.ForeignKey(StoreMenu, on_delete=models.CASCADE, related_name ='product_stores')
...
class CourierProduct(models.Model):
    ...
    courier_status = models.CharField(max_length=30, choices=CourierStatusChoices)
