...
from .serializers import (UserProfileListSerializer, UserProfileDetailSerializer,
                          ...
                          ReviewCreateSerializer, OrderStatusSerializer, StoreCreateSerializer,
...
class StoreViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Store.objects.filter(owner = self.request.user.id)
...
class ReviewCreateAPIView(generics.CreateAPIView):
    ...
    permission_classes = [permissions.IsAuthenticated,  CheckRolePermission]
